...
interface BrowseGearClientProps {
    initialGears: TGear[];
    initialCategories: TCategory[];
}

export default function BrowseGearClient({
    initialGears,
    initialCategories,
}: BrowseGearClientProps) {
    const [gears] = useState<TGear[]>(initialGears);
    const [categories] = useState<TCategory[]>(initialCategories);
