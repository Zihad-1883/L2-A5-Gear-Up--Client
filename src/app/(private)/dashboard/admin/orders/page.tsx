import { getAllRentalsAdmin } from "@/lib/actions/adminActions";
...
export default async function AdminOrdersPage() {
    const ordersRes = await getAllRentalsAdmin();
            ...
            <div className="relative overflow-hidden rounded-3xl border border-slate-800 bg-gradient-to-r from-slate-900 via-slate-900/90 to-teal-950/40 p-6 md:p-8 backdrop-blur-xl shadow-2xl">
                ...
                <div className="relative z-10 space-y-2">
                    ...
                    <h1 className="text-2xl md:text-3xl font-extrabold text-white tracking-tight flex items-center gap-3">
                        ...
                        <span>Platform Rental Orders</span>
                    </h1>
                    <p className="text-sm text-slate-400 max-w-2xl">
                        Inspect, monitor, and moderate all customer rental orders and transactions placed across the GearUp platform.
                    </p>
                </div>
            </div>
